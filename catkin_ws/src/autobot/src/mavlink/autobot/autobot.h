 ...
 */
#pragma once
#ifndef MAVLINK_AUTOBOT_H
#define MAVLINK_AUTOBOT_H

#ifndef MAVLINK_H
    #error Wrong include order: MAVLINK_AUTOBOT.H MUST NOT BE DIRECTLY USED. Include mavlink.h from the same directory instead or set ALL AND EVERY defines from MAVLINK.H manually accordingly, including the #define MAVLINK_H call.
#endif
...
#define MAVLINK_ENABLED_AUTOBOT
