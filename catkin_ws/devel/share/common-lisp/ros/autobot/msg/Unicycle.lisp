...
(cl:defmethod cl:initialize-instance :after ((m <Unicycle>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Unicycle)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name autobot-msg:<Unicycle> is deprecated: use autobot-msg:Unicycle instead.")))

(cl:ensure-generic-function 'velocity-val :lambda-list '(m))
(cl:defmethod velocity-val ((m <Unicycle>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader autobot-msg:velocity-val is deprecated.  Use autobot-msg:velocity instead.")
  (velocity m))

(cl:ensure-generic-function 'w-val :lambda-list '(m))
(cl:defmethod w-val ((m <Unicycle>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader autobot-msg:w-val is deprecated.  Use autobot-msg:w instead.")
  (w m))
